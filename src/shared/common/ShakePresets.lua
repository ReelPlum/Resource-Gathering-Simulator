...
local CameraShakeInstance = require(game:GetService("ReplicatedStorage").Packages.CameraShaker).CameraShakeInstance

local CameraShakePresets = {

	NodeHit = function()
		local c = CameraShakeInstance.new(3, 5, 0.1, 0.1)
